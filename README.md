...
| 2 | [`modulo-2/`](modulo-2/README.md) | Chatbot de FAQs con RAG: chunking, embeddings, búsqueda vectorial y generación con contexto recuperado. Flujo obligatorio completo; bonus (agente evaluador) pendiente. |

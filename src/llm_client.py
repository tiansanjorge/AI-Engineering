...
def ask(
    ...
    completion = client.chat.completions.create(
        ...
        # 0.4: valor moderado elegido a criterio, NO afinado con un
        # experimento. Busca respuestas poco erráticas sin volverlas
        # robóticas; su costo es ruido entre corridas (ver "Trade-offs" del reporte).
        temperature=0.4,
        # 500: techo de seguridad contra respuestas desbordadas, no un
        # valor ajustado. Lo medido en metrics/*.csv no pasa de ~160 tokens
